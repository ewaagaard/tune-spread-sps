"""
Script to investigate tune spread for SPS Pb ions, when the Qy has been shifted down by -0.15, just like in the November 22 MD
...
import input_parameters_Qy_shifted_down
import matplotlib
...
fname_line = 'Sequence_and_Twiss_files/SPS_2021_Pb_ions_Qy_shifted_down.json'
fig_str = 'Pb_ions'
...
bunchLength = input_parameters_Qy_shifted_down.bunchLength_m
    
s.setParameters(
    intensity=input_parameters_Qy_shifted_down.intensity,
    bunchLength=bunchLength,
    emittance_x=input_parameters_Qy_shifted_down.emittance_x,
    emittance_y=input_parameters_Qy_shifted_down.emittance_y, 
    dpp_rms=input_parameters_Qy_shifted_down.dpp_rms,  
    bF=input_parameters_Qy_shifted_down.bF,
...
Qx,Qy=input_parameters_Qy_shifted_down.Qh, input_parameters_Qy_shifted_down.Qv 
...
Q = np.dstack(
    (
        [qx.tolist() + [input_parameters_Qy_shifted_down.Qh] for qx in Qx],
        [qy.tolist() + [input_parameters_Qy_shifted_down.Qv] for qy in Qy],
    )
)
...
tune_diagram = resonance_lines.resonance_lines(input_parameters_Qy_shifted_down.plot_range[0],
            input_parameters_Qy_shifted_down.plot_range[1], np.arange(1,input_parameters_Qy_shifted_down.plot_order+1),
            input_parameters_Qy_shifted_down.periodicity)
...
ax.set_aspect('equal')
plt.tight_layout()
plt.savefig(input_parameters_Qy_shifted_down.figure, dpi=250)
plt.show()
